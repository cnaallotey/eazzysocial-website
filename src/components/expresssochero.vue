<template>
  <div>
    <div class="w-full h-[29.125rem] relative overflow-hidden">
      <img src="../assets/expresssocial.png" class="w-full h-full object-cover" alt="" />
      <div class="w-full h-full absolute top-0 bg-blue-500 bg-opacity-60 px-5">
        <div class="flex flex-col items-center mt-32 max-w-2xl mx-auto">
          <h2 class="font-bold text-5xl text-white leading-7">Express Social</h2>
    ...
    <div class="w-full relative z-10 -translate-y-32">
      <div class="max-w-4xl mx-auto bg-slate-900">
        <div class="w-full p-5 lg:p-8">
          <p class="text-sm text-blue-300 leading-5 font-normal">
          ...
          <div class="mt-8 flex justify-between items-center">
            <div class="flex items-center space-x-2">
              ...
              <p class="text-blue-500 font-semibold text-2xl leading-7">$25</p>
