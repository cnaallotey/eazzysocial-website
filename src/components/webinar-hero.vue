                ...
                <div class="max-w-3xl mx-auto lg:mx-0 mt-8">
                  ...
                  <div class="flex items-center space-x-3 w-fit mx-auto lg:mx-0">
                    ...
                    <div class="">
                      ...
                      <p class="text-lg font-normal text-gray-800 italic">Joe Bradly</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-full lg:w-1/2 px-4 flex items-center justify-center">
              <div class="relative" style="z-index: 0">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1462826303086-329426d1aef5?ix lib=rb-1.2.1&amp;ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80"
                  alt=""
                />
                <!-- <img
