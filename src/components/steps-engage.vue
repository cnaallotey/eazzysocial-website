      ...
      <div class="container max-w-screen-xl px-4 mx-auto">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full lg:w-2/5 px-4 mb-0 lg:mb-0">
            ...
            >
            <h2
              class="mb-12 text-3xl md:text-3xl xl:text-5xl hidden font-medium font-heading leading-none"
            >
              Easy to use. Really
            </h2>
            <p
            ...
            <div class="mb-12 font-heading">
              <button
                class="py-5 px-10 hidden mb-4 md:mb-0 mr-0 md:mr-5 w-full md:w-auto text-xl leading-none font-medium tracking-tighter font-heading bg-gray-50 hover:bg-gray-100 focus:ring-2 focus:ring-gray-50 focus:ring-opacity-50 rounded-xl"
                type="button"
              >
                More
              </button>
