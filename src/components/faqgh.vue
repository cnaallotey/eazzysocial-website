  ...
  <div>
    <section class="bg-white l:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div
          class="grid pt-8 text-left border-t border-gray-200 md:gap-16 l:border-gray-700 md:grid-cols-2"
        >
          <div>
            <div class="mb-10">
              <h3
                class="flex items-center mb-4 text-lg font-medium text-gray-900 l:text-white"
              >
                <svg
                  class="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 l:text-gray-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <div class="mb-10 hidden">
              ...
              <p class="text-gray-500 l:text-gray-400">
                ...
                <a
                  href="#"
                  class="font-medium underline text-blue-600 l:text-blue-500 hover:no-underline"
                  target="_blank"
                  rel="noreferrer"
                  >contact us</a
                >
